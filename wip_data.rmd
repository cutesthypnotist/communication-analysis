...
required_packages <- c(
  ...
  "dtplyr", "textclean", "coin", "rcompanion", "ARTool", "emmeans"
)
...
Don't run this unless you need to recalculate timings.
```{r}
...
Plot the word counts for each condition and round.
